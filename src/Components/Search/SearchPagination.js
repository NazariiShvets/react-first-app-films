    ...
    return (
        <div className='container-for-pagination'>
            <div className='container-for-buttons-of-pagination'>
                ...
                {currentPage > 2 && <span className='btn-pagination'
                                          onClick={paginationHandler}>
                                        {currentPage - 2}
                                    </span>}
                {currentPage > 1 && <span className='btn-pagination'
                                          onClick={paginationHandler}>
                                        {currentPage - 1}
                                    </span>}
                {currentPage > 0 && <span className='btn-pagination active'
                                          onClick={paginationHandler}>
                                        {currentPage}
                                    </span>}
                {currentPage < totalPages && <span className='btn-pagination'
                                                   onClick={paginationHandler}>
                                        {currentPage + 1}
                                    </span>}
                {currentPage + 1 < totalPages && <span className='btn-pagination'
                                                       onClick={paginationHandler}>
                                        {currentPage + 2}
                                    </span>}
